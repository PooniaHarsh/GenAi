...
global showText, textBox, command, go
go = 1
command = ''
...
def audio_to_text():
    ...
    global showText
    wn2 = tkinter.Tk()
    wn2.title("Harsh Audio to PDF converter")
    wn2.geometry('500x500')
    wn2.config(bg='snow3')

    Label(wn2, text='Harsh Audio to Text converter',
...
def text_to_audio():
    ...
    global textBox
    wn1 = tkinter.Tk()
    wn1.title("Harsh Text to Audio converter")
    wn1.geometry('500x500')
    wn1.config(bg='snow3')

    Label(wn1, text='Harsh Text to Audio converter',
          fg='black', font=('Courier', 15)).place(x=60, y=10)
...
wn = tkinter.Tk()
wn.title("Generative AI Text to Audio and Audio to Text converter")
wn.geometry('700x300')                                                   #error
wn.config(bg='LightBlue1')

Label(wn, text='Harsh Text to Audio and Audio to Text converter',
